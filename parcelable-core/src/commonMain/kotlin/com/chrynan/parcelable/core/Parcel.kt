 ...
 */
public interface Parcel : InputParcel,
    OutputParcel {
     ...
     */
    public val dataBufferCapacity: Int
     ...
     */
    public fun setDataPosition(position: Int)
 ...
 */
public expect fun Parcel(): Parcel
 ...
 */
public expect fun Parcel(data: ByteArray): Parcel

/**
 * A convenience function for calling the [Parcel.setDataPosition] with an index value of zero.
 */
@Suppress("NOTHING_TO_INLINE")
public inline fun Parcel.resetDataPosition(): Unit = setDataPosition(position = 0)
